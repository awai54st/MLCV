...
% HG imageset
% image1 = imresize(rgb2gray(imread('HG/img1.JPG')),0.125); % original image
% image2 = imresize(rgb2gray(imread('HG/img1.JPG')),0.0625); % scaled image
...
% Noise Rejection using Euclidean Distance
